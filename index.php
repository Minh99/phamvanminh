						...
						<div class="content">
							<table>
								...
								<tr>
									<td>Địa chỉ Email</td>
									<td>:</td>
									<td>phamvanminh27091999@gmail.com</td>
								</tr>
								<tr>
									<td>Chỗ ở hiện tại</td>
									<td>:</td>
									<td>78 Dương Quảng Hàm - Hải Châu - Đà Nẵng</td>
								</tr>
							</table>
						</div>
					</div>
				...
				<div class="education">
					...
					<table>
						<tr>
							<td>Nơi đào tạo</td>
							<td>:</td>
							<td>Đại học Kiến trúc Đà nẵng</td>
						</tr>
						<tr>
							<td>Chuyên ngành</td>
							<td>:</td>
						...
						<tr>
							<td>Trình độ</td>
							<td>:</td>
							<td>Sinh viên năm 4 (năm cuối)</td>
						</tr>
						<tr>
							<td>Tiếng anh</td>
							<td>:</td>
